        ...
        <table className="table-auto w-full mt-12 mb-12">
          ...
          <tbody>
            <tr>
              ...
              <td className="px-4 py-2">Jr. Front-end Engineer</td>
              <td className="px-4 py-2">Junior, Mid-Level</td>
              <td className="px-4 py-2">
                <Button
                  className="uppercase shadow-lg" 
                  to="/mock-openings/jr-frontend-engineer/"
                >
                  Apply
                </Button>
              </td>
            ...
            <tr className="bg-gray-100">
              ...
              <td className="px-4 py-2">Front-End</td>
              <td className="px-4 py-2">Senior Front-end Developer, React Focus</td>
              <td className="px-4 py-2">Mid-Level, Senior</td>
              <td className="px-4 py-2">
            ...
            <tr>
              ...
              <td className="px-4 py-2">Back-end Node.Js developer</td>
              <td className="px-4 py-2">Junior, Mid-Level</td>
              <td className="px-4 py-2">
